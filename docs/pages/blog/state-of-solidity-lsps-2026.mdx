...
|--------|----------|------------|--------|
| [solidity-language-server](https://github.com/mmsaki/solidity-language-server) | Rust | mmsaki | Active |
| [solc --lsp](https://docs.soliditylang.org/) | C++ | Solidity team | Abandoned |
| [nomicfoundation-solidity-ls](https://github.com/NomicFoundation/hardhat-vscode) | TypeScript | Nomic Foundation | Active |
| [vscode-solidity](https://github.com/juanfranblanco/vscode-solidity) | TypeScript | Juan Blanco | Active |
| [solidity-ls (qiuxiang)](https://github.com/qiuxiang/solidity-ls) | TypeScript | qiuxiang | Active |

Most Solidity developers use either the Nomic Foundation server (bundled with the Hardhat VS Code extension) or Juan Blanco's extension. These are the defaults. They've been around the longest and have the most installs.
...
The project is funded through [Giveth](https://giveth.io/project/solidity-security-starts-in-the-editor) — if you find it useful, consider supporting it.
